 ...
 <nav class="navbar navbar-default">
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
     <form role="form" id="editUserForm" action="/Whatspec/ToEditUser" method="get">
    
     <div class="form-group">
      <label for="username">Username:</label>
      <input type="text" class="form-control" name="username"  id="username" value="<%= request.getAttribute("username")%>"/>
    </div> <div class="form-group">
      <label for="password">Password:</label>
      <input type="text" class="form-control" name="password" id="password" value="<%= request.getAttribute("password")%>"/>
    </div> 
    <input type="hidden" name="uid" id="uid" value="<%= request.getAttribute("user_id")%>" />
